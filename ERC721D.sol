...
contract ERC721D is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function ownerOf(uint256 tokenId) public view virtual override returns (address) {
        address owner = ERC721DStorage.layout()._tokenData[tokenId].owner;
    ...
    function _exists(uint256 tokenId) internal view virtual returns (bool) {
        return ERC721DStorage.layout()._tokenData[tokenId].owner != address(0);
    }
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        AddressData storage addressData = ERC721DStorage.layout()._addressData[to];
        addressData.balance += 1;
        addressData.numberMinted += 1;
        
        TokenData storage tokenData = ERC721DStorage.layout()._tokenData[tokenId];
        tokenData.owner = to;
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        AddressData storage addressData = ERC721DStorage.layout()._addressData[owner];
        addressData.balance -= 1;
    ...
    function _transfer(
        ...
        require(ERC721D.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
        ...
        AddressData storage fromAddressData = ERC721DStorage.layout()._addressData[from];
        fromAddressData.balance -= 1;
        
        AddressData storage toAddressData = ERC721DStorage.layout()._addressData[to];
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721D.ownerOf(tokenId), to, tokenId);
    }
